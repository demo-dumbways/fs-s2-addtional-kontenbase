...
# 2. Menambahkan Waktu pada List Blog

Kita perlu menambahkan satu bagian baru pada bagian list blog yakni bagian waktu postingan. Bagian inilah yang nantinya akan kitaa lakukan manipulasi menggunaakan DOM agar dinamis.

```html {85-87} title=blog.html
<!DOCTYPE html>
<html>
<head>
