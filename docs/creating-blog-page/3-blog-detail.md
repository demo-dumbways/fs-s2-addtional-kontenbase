...
Halaman blog detail merupakan halaman yang menampilkan detail dari daftar postingan blog. Halaman ini bisa diakses dengan cara menambahkan tag `<a href=""></a>` pada bagian list blog halaman blog. 

```html title=blog-detail.html
<!DOCTYPE html>
<html>
  <head>
